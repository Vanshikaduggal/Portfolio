      ...
      <div className="container">
        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <Card className="h-[320px] md:col-span-3 lg:col-span-2">
            ...
            <ToolboxItem toolboxItems={toolboxItems} className="mt-6" itemsWrapperClassName="animate-move-right [animation-duration:30s]"/>
            
          </Card>
          </div>

          <div className="grid gap-8 grid-cols-1 md:grid-cols-5 lg:col-span-3">
          ...
          <Card className="h-[320px] p-0 relative col-span-2 lg:col-span-2">
            ...
            <Image src={smileMemoji} alt="simling memoji" className="size-20"/>
            </div>
          </Card>
